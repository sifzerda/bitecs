...
function BossShip({ groupRef, geo, cfg }) {
        ...
        <group ref={groupRef} visible={false}>
            ...
            {tailFin.enabled && (
                <MirroredPair
                    ...
                    color={tailFin.color}
                    rotationZ={Math.PI - geo.tailFinSplayRad}
                    rotateY
                    flipZAngle
                />
            )}
            ...
            {/* Fuselage */}
            <Panel geometry={geo.fuselage} position={[0, 0, 0.03]} color={fuselage.color} roughness={0.5} />
...
export function BossRenderer() {
    ...
    return (
        <>
            {groupRefs.map((ref, i) => (
                <BossShip key={i} groupRef={ref} geo={geo} cfg={cfg} />
            ))}
