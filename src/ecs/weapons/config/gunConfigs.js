...
const RAW_TYPES = [
    {
        ...
        overrides: { mount: { width: 1.4, height: 0.6, offsetX: 0.5, offsetY: 0.1  } },
    },
    {
        id: "01_shotgun",
        name: "Shotgun",
        ...
        overrides: { mount: { width: 1.4, height: 0.6, offsetX: 0.5, offsetY: 0.18 } },
    },
    {
        id: "02_machinegun",
        name: "Machine Gun",
        ...
        overrides: { mount: { width: 1.5, height: 0.6, offsetX: 0.48, offsetY: -0.03 } },
    },
    {
        id: "03_cryogun",
        name: "Cryo Gun",
        ...
        overrides: { mount: { width: 1.5, height: 0.6, offsetX: 0.8, offsetY: -0.1, } },
    },
    {
        ...
        overrides: { mount: { width: 1.4, height: 0.5, offsetX: 0.8, offsetY: -0.4 } },
    },
    {
        id: "05_acidthrower",
        name: "Acidthrower",
        ...
        overrides: { mount: { width: 1.35, height: 0.5, offsetX: 0.9, offsetY: 0 } },
    },
    {
        ...
        overrides: { mount: { width: 1.4, height: 0.6, offsetX: 0.8, offsetY: -0.01 } },
    },
    {
        id: "07_flamethrower",
        name: "Flamethrower",
        ...
        overrides: { mount: { width: 1.3, height: 0.5, offsetX: 0.5, offsetY: 0.05 } },
    },
    {
        id: "08_lasergun",
        name: "Laser Gun",
        ...
        overrides: { mount: { width: 1.4, height: 0.5, offsetX: 0.8, offsetY: -0.3 } },
    },
    {
        id: "09_arcgun",
        name: "RTL Gun",
        ...
        overrides: { mount: { width: 1.1, height: 0.4, offsetX: 0.4, offsetY: -0.04 } },
    },
    {
        id: "10_plasmagun",
        name: "Plasma Gun",
        ...
        overrides: { mount: { width: 1.3, height: 0.5, offsetX: 0.6, offsetY: -0.3 } },
    },
]
