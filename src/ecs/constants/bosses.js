...
export const BOSSES = [
    ...
    withDefaults({
        key: "grenagegun",
        name: "War Machine",
        gun: { typeId: '03_grenadelauncher', offsetX: 0.8, offsetY: -0.6 },
    ...
    withDefaults({
        ...
        gun: { typeId: '04_missilelauncher', offsetX: 0.9, offsetY: -0.4, scale: 1.0 },
    ...
    withDefaults({
        key: "acidthrowergun",
        name: "Space Tractor",
        gun: { typeId: '07_acidthrower', offsetX: 0.70, offsetY: -0.10, scale: 1.0 },
    ...
    withDefaults({
        ...
        gun: { typeId: '06_cryogun', offsetX: 0.87, offsetY: -0.5 },
    ...
    /*
        ...
        key: "plasmagun",
        name: "Starscream", 
       gun: { typeId: '00_raygun', offsetX: 0.4, offsetY: -0.30, scale: 1.0 },    
...
withDefaults({
    ...
    gun: {
        enabled: true,
        typeId: "05_flamethrower", // Change to any weapon you like
        offsetX: 0.5,
        offsetY: -0.4,
        scale: 1.0,
        mirrored: true,
