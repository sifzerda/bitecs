...
withDefaults({
        ...
        gun: { typeId: '06_cg', offsetX: 0.7, offsetY: -0.4 },
        fuselage: { color: '#cfffff', tipY: 0.18, shoulderY: 0.56, shoulderWidth: 0.44, waistY: -0.85, waistWidth: -0.40, tailY: -0.41, tailWidth: -0.27, notchY: 0.80 },
        cockpit: { color: '#6c00ff', topY: 0.60, topWidth: 0.21, midY: 0.11, midWidth: 0.35, bottomY: 0.23, bottomWidth: 0.20 },
        wing: { color: '#004cd1', rootX: 0.02, rootY: 0.36, tipX: 0.41, tipY: -0.01, trailX: 0.43, trailY: -0.60, innerX: 0.31, innerY: -0.39 },
        ...
        engineIntake: { enabled: true, color: '#000000', width: -0.20, height: 0.83, offsetX: 0.14, offsetY: 0.33 },
        hullVent: { enabled: false, color: '#3a6bd5' },
