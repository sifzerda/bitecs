...
if (gameState.wave > 0 &&
    ...
    // Cycle through the boss roster so each boss fight looks different —
    // bossNumber 1 → BOSSES[0], 2 → BOSSES[1], wrapping back around once
    // you've added enough bosses to cover every number.
    const bossKey = BOSSES[(bossNumber - 1) % BOSSES.length].key
